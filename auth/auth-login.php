...
<head>
    ...
    <title>FastCheck - Giriş Yap</title>
            ...
            <div class="content-body">
                <div class="auth-wrapper auth-basic px-2">
                    <div class="auth-inner my-2">
                       ...
                       <h4 class="card-title mb-1">FastCheck'e Hoş Geldiniz! 👋</h4>
                                <p class="card-text mb-2">Lütfen hesabınıza giriş yapın ve maceraya başlayın</p>
                                <form id="loginForm" method="POST">
                                    <div class="mb-1">
                                        <label class="form-label" for="login-email">Kullanıcı Adı</label>
                                        <input class="form-control" name="username" id="username" type="text"  placeholder="FastCheck" aria-describedby="login-email" autofocus="" tabindex="1" />
                                    </div>
                                    <div class="mb-1">
                                        <div class="d-flex justify-content-between">
                                            <label class="form-label" for="login-password">Parola</label><a href="https://discord.gg/aQpVxkdn" target="_blank"><small>Parolanızı mı unuttunuz?</small></a>
                                        </div>
                                ...
                                <p class="text-center mt-2"><span>Platformumuzda yeni misiniz?</span><a href="https://discord.gg/vKjAUedU5h"><span>&nbsp;Üyelik İçin Discord Adresimize Gelin</span></a></p>
