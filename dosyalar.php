...
<head>
    ...
    <title>Sh4reCheck - Dosyalar</title>
                                    ...
                                    <div class="card file-manager-item file">
                                        ...
                                        <div class="card-img-top file-logo-wrapper">
                                            ...
                                            <div class="d-flex align-items-center justify-content-center w-100">
                                                <img src="app-assets/Sh4reimage/rar.png" alt="file-icon" height="35" />
                                            </div>
                                        </div>
                                        <div class="card-body">
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            <div class="tab-pane fade show active" id="details-tab" role="tabpanel" aria-labelledby="details-tab">
                                                <div class="d-flex flex-column justify-content-center align-items-center py-5">
                                                    <img src="app-assets/Sh4reimage/rar.png" alt="file-icon" height="64" />
