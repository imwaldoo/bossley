...
<head>
    ...
    <title>Sh4reCheck - Terminal</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Sh4recheck Editör</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="col-sm-12">
                                            <div id="snow-wrapper">
                                                <div id="snow-container">
                                                    ...
                                                    <div class="editor">
                                                        <h1 class="ql-align-center">Sh4recheck Metin Editörü</h1>
                                                        <p class="card-text"><br /></p>
                                                        <p class="card-text">
                                                            Sh4recheck ücretsiz olarak, <a href="discord" target="_blank">discord</a> sunucumuzda üyelik çekilişlerini başlattık.
                                                        </p>
                                                        <p class="card-text"><br /></p>
