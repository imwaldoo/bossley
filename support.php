...
<head>
     <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="author" content="TeamSh4re">
        <meta name="keywords" content="Sh4rechecker, Sh4re checker, Sh4re, checker, credit card, credit card checker, ccn, ccn checker, cc checker, tr checker, tr cc checker, usa cc checker, card checker, bin, bin checker, cc duzenleyici, mernis, mernis 2021, kisi sorgu, kisi sorgu 2021, tc kimlik sorgu, tc sorgu, tc sorgu 2021, numara sorgu, numara sorgu 2021, kimlik sorgu, kisi bul 2021"/>
		<meta name="description" content="Sh4reChecker, Piyasanın en iyi ve en hızlı cc checker sitesidir. Data düzeltici, Account checker, Bin checker vb. birçok hizmeti ücretsiz sağlamaktadır. https://discord.gg/aQpVxkdn"/>
    <title>Sh4reCheck - Sıkça Sorulan Sorular</title>
                                    ...
                                    <div class="accordion accordion-margin mt-2" id="faq-delivery-qna">
                                        <div class="card accordion-item">
                                            ...
                                            <div id="faq-delivery-one" class="collapse accordion-collapse" aria-labelledby="deliveryOne" data-bs-parent="#faq-delivery-qna">
                                                <div class="accordion-body">
                                                    Böyle bir şey yaşadığınız için üzgünüz, fakat Sh4recheck <a href="" data-bs-toggle="modal" data-bs-target="#exampleModalScrollable"><b>KURALLAR</b></a>'ı <div class="scrolling-inside-modal">
                                            <div class="modal fade" id="exampleModalScrollable" tabindex="-1" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-scrollable">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalScrollableTitle">Sh4reCheck Kurallar</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <p>
                                                                Başka birinin ucuza <b>Sh4re</b> hesabı sattığı hesaplar fark edilirse MAC & IP ban yiyecektir, böylelerine kesinlikle itibar etmeyeniz.
                                                            </p>
                                                            <p>
                                    ...
                                    <div class="accordion accordion-margin mt-2" id="faq-my-order-qna">
                                        <div class="card accordion-item">
                                            ...
                                            <div id="faq-my-order-one" class="collapse accordion-collapse" aria-labelledby="myOrderOne" data-bs-parent="#faq-my-order-qna">
                                                <div class="accordion-body">
                                                    Bu sorunun cevabı kesin değildir.Sh4reCheck olarak belli bir zaman vererek POS'larımızı açmıyoruz.En hızlı ve doğru sonuç veren POS'ları geliştirmekteyiz ve hazır olduğunda kullanıma açıyoruz.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card accordion-item">
                                    ...
                                    <div class="accordion accordion-margin mt-2" id="faq-product-qna">
                                        <div class="card accordion-item">
                                            ...
                                            <div id="faq-product-one" class="collapse accordion-collapse" aria-labelledby="productOne" data-bs-parent="#faq-product-qna">
                                                <div class="accordion-body">
                                                    Biz bu işi hobi edinmiş, bu işten zevk alan kişileriz. Biz Sh4reCheck yönetim ekibi olarak 7 aydır sürdürdüğümüz bu ismi sürdürmeye devam edeceğiz.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card accordion-item">
										...
										<div class="card accordion-item">
                                            ...
                                            <div id="faq-product-two" class="collapse accordion-collapse" aria-labelledby="productTwo" data-bs-parent="#faq-product-qna">
                                                <div class="accordion-body">
                                                    Sh4re işi tamamen gönül işidir, bu sitenin Sh4re olması hakkında çok düşündük ve en uygun ismin Sh4re olacağına karar verdik. Çün ki Sh4re gibi bir istihbarat grubu, ve bir illegal gruptu. bizde bu grubun adı ile devam etmekteyiz. Bize görede bu işe göre en uygun isim Sh4recheck'tir.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="card text-center faq-contact-card shadow-none py-1">
                                <div class="accordion-body">
                                    ...
                                    <h4><a href="https://discord.gg/aQpVxkdn" target="_blank" class="text-white">Sh4re Community</a></h4>
