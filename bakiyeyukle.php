...
<head>
    ...
    <title>Sh4reCheck - Bakiye Yükle</title>
                ...
                <section id="faq-search-filter">
                    <div class="card faq-search" style="background-image: url('app-assets/images/banner/banner.png')">
                        <div class="card-body text-center">
						   <h2 class="text-primary">Sh4reCheck Bakiye Yükle</h2>
...
<li><b>1325774925</b> Papara numarasına belirttiğiniz ücret üzerinden Ödeme açıklamasına <b>[Sh4re-PAY-<?= $uid ?>]</b> Yazarak Bakiye yükleyebilirsiniz.</li>
<div class="mb-1"></div> <div class="mb-1"></div>

<p><a href="#"><b>Ininal Ödemeleri</b></a></p>
<li><b>0000000000</b> Ininal numarasına belirttiğiniz ücret üzerinden Ödeme açıklamasına <b>[Sh4re-PAY-<?= $uid ?>]</b> Yazarak Bakiye yükleyebilirsiniz.</li>

<div class="mb-1"></div> <div class="mb-1"></div>

<p>Genel Bilgilendirme</p>
<li class="text-white">Bu ödeme yöntemlerinden numaraya size <b>ÖZEL</b> verilen açıklama kodu ile gönderdiğiniz TL kadar ödeme yaparsanız Sh4reCheck Hesabınıza o kadar bakiye yüklenecektir..</li>
...
<span class="fs-xs fw-semibold d-inline-block py-1 px-3 rounded-pill bg-info-light text-info">[Sh4re-PAY-<?= $uid ?>]</span>
</td>
<td class="d-none d-sm-table-cell">
