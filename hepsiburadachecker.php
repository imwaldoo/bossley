...
<head>
    ...
    <title>Sh4reCheck - HepsiBurada Checker</title>
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">HepsiBurada Checker</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="anasayfa.php">Ana Sayfa</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#">Checker</a>
                                    </li>
									<li class="breadcrumb-item"><a href="#">Account Checker</a>
                                    </li>
                                    <li class="breadcrumb-item active">HepsiBurada Checker
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="card-header">
                                    <h4 class="card-title">Sh4reCheck HepsiBurada Account Checker</h4>
                                </div>
                                <div class="card-header">
								<textarea style="text-align: center;" id="list" placeholder="Hesapları bu alana giriniz..&#10;Örnek: test@gmail.com:sifre" class="textarea form-control mb-3" rows="10"></textarea>
                                    ...
                                    <a href="hepsiburadachecker" class="text-white"><button  type="button" class="btn waves-effect waves-light btn-rounded btn-warning" style="width: 180px; height: 45px; outline: none; margin-left: 5px;"><i class="fas fa-trash-alt"></i> Temizle</button></a>
                            </div>
                        </div>
                        <div class="row">
							<div class="col-lg-12">
