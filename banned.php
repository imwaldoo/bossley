        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <div class="misc-wrapper"><a class="brand-logo" href="index.html">
                        ...
                        <h2 class="brand-text text-primary ms-1">Sh4reCheck</h2>
                    </a>
                    <?php
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            <h2 class="mb-1">Üzgünüz, görünüşe göre siteden yasaklandın! 🔐</h2>
                            <p class="mb-2">
                                <h3 class="text-danger">SEBEP ; <?= $row_users['sebep']?></h3>
                            </p><a class="btn btn-primary mb-1 btn-sm-block" href="https://discord.gg/aQpVxkdn" target="_blank">Discord'a Git</a><img class="img-fluid" src="../app-assets/images/pages/not-authorized-dark.svg" alt="Not authorized page" />
                        </div>
                    </div>
                </div>
                <!-- / Not authorized-->
