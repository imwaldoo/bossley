...
<head>
     <meta name="viewport" content="width=device-width, initial-scale=1.0">
		...
		<meta name="description" content="Sh4reChecker, Piyasanın en iyi ve en hızlı cc checker sitesidir. Data düzeltici, Account checker, Bin checker vb. birçok hizmeti ücretsiz sağlamaktadır. https:discord.gg/JvpMh4xkPe"/>
    <title>Sh4reCheck - Nüfus Sorgu</title>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Sh4reCheck Nüfus Sorgu</h4>
                                </div>													
                                <div class="card-body">
                                    <div class="row">
                                            <div class="mb-1">
