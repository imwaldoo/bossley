...
<head>
    ...
    <title>Sh4reCheck - Anasayfa</title>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="card card-apply-job">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-1">
                                    <div class="d-flex flex-row">
                                        <div class="avatar me-1">
                                            <img src="app-assets/Sh4reimage/kullanici.jpg" alt="Avatar" width="42" height="42" />
                                        </div>
                                        <div class="user-info">
                                ...
                                <h5 class="apply-job-title">Sh4recheck 1 numara <3</h5><br>
								...
								<p class="card-text mb-2">
                                   <span class="badge rounded-pill badge-light-success"><b>Sh4re Bakiye:</b></span> <?= $row['bakiye'] ?>₺
                                </p>
