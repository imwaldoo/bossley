...
<head>
    ...
    <title>Sh4reCheck - Üyelik Paketleri</title>
            ...
            <div class="content-body">
                <section id="pricing-plan">
                    ...
                    <div class="text-center">
                        <h1 class="mt-5">Sh4reCheck Üyelik Paketleri</h1>
                        <p class="mb-2 pb-75">
                            ...
                            <div class="col-12 col-lg-10 col-lg-offset-3 mx-auto">
                                <div class="pricing-trial-content d-flex justify-content-between">
                                    <div class="text-center text-md-start mt-3">
                                        ...
                                        <h5>Discord sunucumuza gelip çekiliş ile 14 günlük Sh4rePremium üyeliği kazanma şansı elde edin.</h5>
                                    ...
                                    <div class="card accordion-item">
                                        <h2 class="accordion-header" id="headingThree">
                                            <button class="accordion-button collapsed" data-bs-toggle="collapse" role="button" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                Deneme Amacıyla Sh4rePremium Alabilir Miyim?
                                            </button>
                                        </h2>
                                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                Böyle bir şey ne yazık ki söz konusu değildir.
												Sh4reCheck yetkilisi olduğunu iddia eden kişilerle iletişim kurmayınız , 
